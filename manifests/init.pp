...
# ----------
#
# version: for package installation, either package version or puppet package installed, latest. for binary downloads, either snap version (0.17.0), latest, latest_build, or git sha1. (default: latest)
#
# pkg_install: whether to use snap package for software installation. (default true)
#
# pkg_repo: use packagecloud.io repo or custom repo.
#
...
class snap (
  ...
  $pkg_url        = undef,            # url to download package
